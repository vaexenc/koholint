...
function ChatPanel({
	...
	return (
		<div className="fixed top-2 bottom-2 left-2 flex w-72 flex-col rounded bg-black/70 font-mono text-xs text-neutral-100 shadow-lg backdrop-blur">
			<div className="border-b border-white/10 px-3 py-2 text-neutral-400">chat</div>
