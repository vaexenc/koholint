import ConnectionWidget, {WIDGET_CORNER} from "@/components/ConnectionWidget";
import type {Meta, StoryObj} from "@storybook/tanstack-react";
import {fn} from "storybook/test";

// the widget is an overlay its host positions; these stories opt into the fixed
// corner preset, so they render on a full-bleed canvas instead of the default
// padded frame.
const meta = {
	...
	args: {
		...
		status: "connected",
		playerCount: 42,
		className: WIDGET_CORNER["top-left"],
	},
	argTypes: {
...
export const BottomLeft: Story = {
	args: {className: WIDGET_CORNER["bottom-left"]},
};
