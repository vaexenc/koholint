...
import type {ChatSettings} from "@/client/settings/chatSettings";
...
type ChatPanelProps = ChatPanelLayout & {
	messages: readonly ChatMessage[];
	onSend: (text: string) => void;
	settings: ChatSettings;
	onSettingsChange: (settings: ChatSettings) => void;
	// gates the compose row: only a live connection can carry a line.
	status: ConnectionStatus;
	// omitted where there is no roster to show (the section disappears with it).
