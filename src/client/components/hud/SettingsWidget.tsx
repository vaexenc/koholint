...
import {MovementKeybinds} from "@/client/components/hud/MovementKeybinds";
...
import type {KeyBindings} from "@/shared/game";
	...
	return (
		<Dialog open={open} onOpenChange={handleOpenChange}>
			...
			<DialogContent className="select-none sm:max-w-sm">
				...
				{/* the guard above already returned when both are empty, so this
