...
export const HUD_PILL =
	"inline-flex items-center rounded-full bg-black/70 text-xs text-neutral-100 backdrop-blur";
...
export const HUD_POPOVER =
	"rounded-xl border-0 bg-black/70 text-xs text-neutral-100 shadow-none ring-0 backdrop-blur";
